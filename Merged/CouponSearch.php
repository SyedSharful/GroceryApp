...
<html lang="en">
  <head>
    ...
    <!--Styles for the table, dunno if it can moved into a .css file-->
    <style>
    table {
...
<!--Search Button -->
<!--Submit action goes back into the CouponSearch-->
...
<table>
    ...
    <!--Checks the Grocery_Coupon database to see if there are any search queries-->
    <?php
        include("CouponSearchdb.php");
    ?>
</table>
