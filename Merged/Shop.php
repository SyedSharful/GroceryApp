...
<div class="showCase">
  <section class="shopItems">
    ...
    <div class="container">
      <div class="items">
          <img src="milk1.jpeg" class="img-fluid" alt="Responsive image">               
          <h5>Berkshare Whole Milk</h5>
...
<section class="pagesandcontacts">
    ...
    <a href="websiteTwo.html"><button type="button" class="btn btn-info ">1</button></a></button>
    <a href="Shop.html"><button type="button" class="btn btn-info active">2</button></a></button>
...
<footer>
    ...
    <div class="ghost"> <h6>?? @GroceryApp </h6></div>
</footer>
