...
INSERT INTO `Grocery_Account` (`Username`, `Email`, `Password`, `First_Name`, `Last_Name`, `Address`, `Phone_Number`, `user_type`) VALUES
('Archbacker', 'addr@google.com', '123456', 'Test', 'A', '111 Fake Dr.', '123-456-7890', 'admin'),
('Kevin', 'klz4', '123456', 'Kevin', 'Zhou', '122 Waypark ave.', '642-131-1111', 'user'),
('klz4', 'klz4@njit.edu', '123456', 'Kevin', 'Zhou', '113 Burgandy lane', '222-222-2222', 'user');
